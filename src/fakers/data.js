...
export const serv = [
	{
		...
		arabicDesc: 'تعريف الجمهور بالعلامة التجارية وزيادة عدد العملاء وتعزيز العلاقة معهم وتوليد إعلام عن الشركة وزيادة الإيرادات بتعزيز التواجد على منصات السوشيال ميديا',
		englishDesc:
	...
	},
	{
		...
		arabicDesc: 'تريد تسويق موقعك او نشاطك وتبحث عن أفضل الشركات لتقوم بهذه المهمة؟ إن فريقنا من المسوقين المحترفين جاهزون لتنفيذ ما قد تحتاج إليه إلى الوصول لزيادة معدل التحويل والأرباح',
		englishDesc:
